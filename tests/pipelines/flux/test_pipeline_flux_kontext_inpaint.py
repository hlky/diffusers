...
from ...testing_utils import backend_empty_cache, floats_tensor, require_big_accelerator, slow, torch_device
...
class FluxKontextInpaintPipelineSlowTests(unittest.TestCase):
    pipeline_class = FluxKontextInpaintPipeline
    ...
    def get_inputs(self, seed=0):
        ...
        return {
            ...
            "mask_image": PIL.Image.new("L", (512, 512), 255),
    ...
    def test_flux_kontext_inpaint_inference(self):
