...
class FluxControlNetInpaintPipelineSlowTests(unittest.TestCase):
    ...
    controlnet_repo_id = "InstantX/FLUX.1-dev-Controlnet-Canny-alpha"
    ...
    def test_flux_controlnet_inpaint_inference(self):
        controlnet = FluxControlNetModel.from_pretrained(self.controlnet_repo_id, torch_dtype=torch.bfloat16)
