...
class FluxRFInversionNoisePipeline(DiffusionPipeline, FluxLoraLoaderMixin):
    r"""
    The Flux pipeline for [RFInversion](https://arxiv.org/pdf/2410.10792) Noise (Algorithm 1).
